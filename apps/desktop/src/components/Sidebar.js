...
const Sidebar = ({ currentView, onViewChange }) => {
    ...
    return (<div className="sidebar">
      ...
      <nav className="sidebar-nav">
        {menuItems.map(item => (<button key={item.id} className={`nav-item ${currentView === item.id ? 'active' : ''}`} onClick={() => onViewChange(item.id)} title={item.description}>
      ...
      <div className="sidebar-footer">
        <div className="vault-status">
          ...
          {vaultStatus.last_sync && (<p className="last-sync">
