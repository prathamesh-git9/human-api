...
const InsightsView = () => {
    const [, setInsights] = useState(null);
    ...
    return (<div className="insights-view">
      ...
      {isLoading ? (<div className="loading">Loading insights...</div>) : (<div className="insights-content">
          ...
          <div className="insights-sections">
            <div className="insight-section">
              ...
              <div className="trend-chart">
                ...
                <div className="placeholder-chart">📈 Chart visualization coming soon</div>
              </div>
            </div>
            ...
            <div className="insight-section">
              ...
              <div className="tags-analysis">
                ...
                <div className="placeholder-tags">🏷️ Tag analysis coming soon</div>
              </div>
            </div>
            ...
            <div className="insight-section">
              ...
              <div className="query-analysis">
                ...
                <div className="placeholder-queries">🔍 Query analysis coming soon</div>
              </div>
            </div>
          </div>

          <div className="insights-actions">
            <button onClick={loadInsights} className="refresh-button" disabled={isLoading}>
              🔄 Refresh Insights
            </button>

            <button onClick={() => invoke('export_data', { format: 'json' })} className="export-button">
              📤 Export Data
            </button>
          </div>
        </div>)}
