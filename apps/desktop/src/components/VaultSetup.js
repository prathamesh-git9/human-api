...
const VaultSetup = ({ onVaultCreated }) => {
        ...
        {step === 1 && (<div className="setup-step">
            ...
            <form onSubmit={e => {
              ...
              <div className="form-group">
                ...
                <input id="vaultName" type="text" value={vaultConfig.name} onChange={e => setVaultConfig(prev => ({ ...prev, name: e.target.value }))} placeholder="My Personal Vault" required/>
              </div>

              <div className="form-group">
                <label htmlFor="description">Description (Optional)</label>
                <textarea id="description" value={vaultConfig.description} onChange={e => setVaultConfig(prev => ({ ...prev, description: e.target.value }))} placeholder="A brief description of what this vault contains" rows={3}/>
              </div>
        ...
        {step === 2 && (<div className="setup-step">
            ...
            <form onSubmit={handleCreateVault}>
              <div className="form-group">
                ...
                <input id="masterPassword" type="password" value={masterPassword} onChange={e => setMasterPassword(e.target.value)} placeholder="Enter a strong password" required minLength={8}/>
              ...
              <div className="form-actions">
                ...
                <button type="submit" disabled={isCreating || !masterPassword || !confirmPassword}>
