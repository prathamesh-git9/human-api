          ...
          <div className="form-section">
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={e => setSettings(prev => ({ ...prev, vaultName: e.target.value }))}
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                placeholder="Optional description of your vault"
                rows={3}
              />
            </div>
          </div>
            ...
            <div className="form-group">
              <label className="checkbox-label">
                <input
                  ...
                  onChange={e =>
                    setSettings(prev => ({ ...prev, encryptionEnabled: e.target.checked }))
                  }
                  disabled
                />
                Encryption Enabled
