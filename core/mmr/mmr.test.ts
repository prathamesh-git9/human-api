...
import { mmr, mmrWithConfig, MMRItem, MMRConfig } from './mmr';

describe('MMR re-ranker', () => {
    const mockItems: MMRItem[] = [
        {
            id: 'item1',
            vec: [1, 0, 0],
            baseScore: 0.9
    ...
    describe('mmrWithConfig', () => {
        it('works with config object', () => {
            const config: MMRConfig = { lambda: 0.7, k: 2 };
