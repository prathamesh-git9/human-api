...
import { chunkText, chunkTextWithConfig, validateChunks } from './chunker';
describe('Text chunker', () => {
    ...
    describe('overlap handling', () => {
        it('creates overlapping chunks', () => {
            const text = 'This is a long text that should be split into multiple chunks with overlap between them.';
