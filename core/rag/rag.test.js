...
import { buildContextBlocks, buildQAPrompt, buildEmptyContextPrompt, } from './prompt';
import { enforceTokenBudget, enforceTokenBudgetWithPriority, getTokenCount, fitsWithinBudget, } from './budget';
...
describe('Token budget enforcement', () => {
    describe('enforceTokenBudget', () => {
        ...
        it('truncates text that exceeds budget', () => {
            const longText = 'This is a very long text that should be truncated when the token budget is exceeded. '.repeat(10);
