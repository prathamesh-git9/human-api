 ...
 */
export async function wrapDEK(kekKey: Uint8Array, dekPlain: Uint8Array): Promise<WrapResult> {
 ...
 */
export async function seal(dek: Uint8Array, plaintext: Uint8Array): Promise<EncryptResult> {
 ...
 * @returns Encrypted data with nonce
 */
export async function sealString(dek: Uint8Array, text: string): Promise<EncryptResult> {
