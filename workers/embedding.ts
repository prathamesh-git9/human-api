...
export class EmbeddingWorker {
  ...
  private async handleJobSuccess(job: EmbeddingJob, result: EmbeddingResult): Promise<void> {
  ...
  private async handleJobFailure(job: EmbeddingJob, error: any): Promise<void> {
    job.retries++;
